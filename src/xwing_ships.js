...
mistHunter.normal = [ TL(2), BL(2), BR(2), TR(3), F(4) ];
...
mistHunter.closing[2] = [ TR(1), TR(1), TR(1), TR(1), TR(1), TR(1), TR(1), TR(1), K(3), K(3) ];
mistHunter.closing[3] = [ BR(1), TR(1), TR(1), TR(1), TR(1), TR(1), TR(1), TR(1), K(3), K(3) ];
mistHunter.closing[4] = [ TL(1), F(3), TR(3), K(3), K(3), K(3), K(4), K(4), K(4), K(4) ];
mistHunter.closing[5] = [ BL(1), TL(1), TL(1), TL(1), TL(1), TL(1), TL(1), TL(1), K(3), K(3) ];
mistHunter.closing[6] = [ TL(1), TL(1), TL(1), TL(1), TL(1), TL(1), TL(1), TL(1), K(3), K(3) ];
...
mistHunter.away[1] = [ BR(2), BR(2), BR(2), BR(2), BR(3), BR(3), BR(3), BR(3), TR(3), TR(3) ];
mistHunter.away[2] = [ BR(2), BR(3), BR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3) ];
mistHunter.away[3] = [ TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), K(3), K(4), K(4) ];
mistHunter.away[4] = [ TL(1), TL(2), TR(3), K(3), K(3), K(3), K(4), K(4), K(4), K(4) ];
mistHunter.away[5] = [ TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), K(3), K(4), K(4) ];
mistHunter.away[6] = [ BL(2), BL(3), BL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3) ];
mistHunter.away[7] = [ BL(2), BL(2), BL(2), BL(2), BL(3), BL(3), BL(3), BL(3), TL(3), TL(3) ];

mistHunter.far = [];
mistHunter.far[0] = [ BL(3), F(3), F(3), F(3), F(3), F(4), F(4), F(4), F(4), BR(3) ];
mistHunter.far[1] = [ BR(2), BR(2), BR(2), BR(2), BR(3), BR(3), BR(3), BR(3), TR(3), TR(3) ];
mistHunter.far[2] = [ TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3) ];
mistHunter.far[3] = [ TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3) ];
mistHunter.far[4] = [ TL(1), TL(1), TL(2), TL(2), TL(2), TR(3), TR(3), TR(3), K(4), K(4) ];
mistHunter.far[5] = [ TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3) ];
mistHunter.far[6] = [ TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3) ];
mistHunter.far[7] = [ BL(2), BL(2), BL(2), BL(2), BL(3), BL(3), BL(3), BL(3), TL(3), TL(3) ];

mistHunter.stressed = [];
mistHunter.stressed[0] = [ BL(1), F(1), F(1), F(2), F(2), F(3), F(3), F(4), F(4), BR(1) ];
mistHunter.stressed[1] = [ F(1), BR(1), BR(1), BR(1), BR(1), BR(2), BR(2), BR(2), TR(3), TR(3) ];
mistHunter.stressed[2] = [ TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3) ];
mistHunter.stressed[3] = [ TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3), TR(3) ];
mistHunter.stressed[4] = [ TL(2), TL(2), TL(2), TL(2), TL(2), TR(3), TR(3), TR(3), TR(3), TR(3) ];
mistHunter.stressed[5] = [ TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3) ];
mistHunter.stressed[6] = [ TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3), TL(3) ];
mistHunter.stressed[7] = [ F(1), BL(1), BL(1), BL(1), BL(1), BL(2), BL(2), BL(2), TL(3), TL(3) ];
...
var sarpielCaster = {};
sarpielCaster.name = "sarpiel Caster";
sarpielCaster.image = "img/ship_lancer.png";
sarpielCaster.faction = "scum";
sarpielCaster.simple = [ F(2), TL(2), BL(2), F(2), BR(2), TR(2), F(3) ];
sarpielCaster.normal = [ BL(1), F(1), BR(1), TL(2), BL(2), BR(2), TR(2), F(5) ];
sarpielCaster.difficult = [ K(5) ];
sarpielCaster.actions = (FOCUS + TARGET_LOCK + EVADE + ROTATE_ARC);

sarpielCaster.closing = [];
sarpielCaster.closing[0] = [ BL(1), F(1), F(1), F(1), F(2), F(2), F(2), F(2), K(5), K(5) ];
sarpielCaster.closing[1] = [ F(1), BR(1), BR(1), BR(1), BR(2), BR(2), BR(2), BR(2), TR(2), TR(2) ];
sarpielCaster.closing[2] = [ TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), K(5), K(5) ];
sarpielCaster.closing[3] = [ BR(1), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), K(5), K(5) ];
sarpielCaster.closing[4] = [ TL(2), F(5), TR(2), K(5), K(5), K(5), K(5), K(5), K(5), K(5) ];
sarpielCaster.closing[5] = [ BL(1), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), K(5), K(5) ];
sarpielCaster.closing[6] = [ TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), K(5), K(5) ];
sarpielCaster.closing[7] = [ F(1), BL(1), BL(1), BL(1), BL(2), BL(2), BL(2), BL(2), TL(2), TL(2) ];

sarpielCaster.away = [];
sarpielCaster.away[0] = [ F(5), F(5), F(5), F(5), F(5), F(5), F(5), F(5), F(5), F(5) ];
sarpielCaster.away[1] = [ BR(1), BR(1), BR(2), BR(2), BR(2), BR(2), BR(2), BR(2), TR(2), TR(2) ];
sarpielCaster.away[2] = [ BR(1), BR(2), BR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2) ];
sarpielCaster.away[3] = [ TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), K(5), K(5), K(5) ];
sarpielCaster.away[4] = [ TL(2), TR(2), TR(2), K(5), K(5), K(5), K(5), K(5), K(5), K(5) ];
sarpielCaster.away[5] = [ TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), K(5), K(5), K(5) ];
sarpielCaster.away[6] = [ BL(1), BL(2), BL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2) ];
sarpielCaster.away[7] = [ BL(1), BL(1), BL(2), BL(2), BL(2), BL(2), BL(2), BL(2), TL(2), TL(2) ];

sarpielCaster.far = [];
sarpielCaster.far[0] = [ F(5), F(5), F(5), F(5), F(5), F(5), F(5), F(5), BR(1), BR(2) ];
sarpielCaster.far[1] = [ BR(1), BR(1), BR(2), BR(2), BR(2), BR(2), BR(2), BR(2), TR(2), TR(2) ];
sarpielCaster.far[2] = [ TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2) ];
sarpielCaster.far[3] = [ TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2) ];
sarpielCaster.far[4] = [ TL(2), TL(2), TL(2), TL(2), TR(2), TR(2), TR(2), TR(2), K(5), K(5) ];
sarpielCaster.far[5] = [ TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2) ];
sarpielCaster.far[6] = [ TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2) ];
sarpielCaster.far[7] = [ BL(1), BL(1), BL(2), BL(2), BL(2), BL(2), BL(2), BL(2), TL(2), TL(2) ];

sarpielCaster.stressed = [];
sarpielCaster.stressed[0] = [ BL(1), BL(2), F(1), F(1), F(2), F(2), F(2), F(2), F(3), F(5) ];
sarpielCaster.stressed[1] = [ F(1), BR(1), BR(1), BR(1), BR(2), BR(2), BR(2), BR(2), TR(2), TR(2) ];
sarpielCaster.stressed[2] = [ TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2) ];
sarpielCaster.stressed[3] = [ TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2), TR(2) ];
sarpielCaster.stressed[4] = [ TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TR(2), TR(2), TR(2), TR(2) ];
sarpielCaster.stressed[5] = [ TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2) ];
sarpielCaster.stressed[6] = [ TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2), TL(2) ];
sarpielCaster.stressed[7] = [ F(1), BL(1), BL(1), BL(1), BL(2), BL(2), BL(2), BL(2), TL(2), TL(2) ];
...
acd.faction = "rebel"; // T2 needs to be split between B2 and T3 //
...
var ships = [ abd, acd,  ard, griffon, harpy, sarpiel, shadow, wyvern, ybd, ygd]; //arc170,awing, bwing, carrier, corvette, decimator, ewing, falcon, ghost, houndstooth, hwk290, ig2000, kihraxz, kwing, lambda, m3a, mistHunter, outrider, phantom, protectorate, punishingOne, quadjumper, raider, sarpielCaster, slave1, starviper, t70xwing, tie, tieAdvanced, tieBomber, tieDefender, tieInquisitor, tieInterceptor, tiePhantom, tiePunisher, tieStriker, tiefo, tiesf, transport, upsilon, uwing, xwing, ywing, z95 ];